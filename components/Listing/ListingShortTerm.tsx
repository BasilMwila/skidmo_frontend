...
const RentShortTermScreen = () => {
  ...
  const navigation = useNavigation();
      ...
      React.useEffect(() => {
        navigation.setOptions({ title: 'Short-Term Listing' });
      }, [navigation]);
  ...
  const [bedroomLaundry, setBedroomLaundry] = useState<string[]>([])
  const [kitchenDining, setKitchenDining] = useState<string[]>([])
  ...
  const handlePublish = async () => {
    console.log("Starting short-term property publication process...")
    ...
    try {
      let response
      const baseData = {
        term_category: "SHORT" as const,
        purpose: "RENT" as const,
        rental_price: Number.parseFloat(price),
        price_negotiable: false,
        title: `${selectedType} for short-term rent in ${address}`,
        address,
        description: additionalInfo || `${selectedType} available for short-term rent`,
      ...
      console.log("Base property data for short-term rent:", baseData)
  ...
  const renderHotelFilters = () => (
    <>
      ...
      {renderNumberSelector("Room Type", roomType, setRoomType, roomTypeOptions, "roomType")}
      {renderNumberSelector("Bed Type", bedType, setBedType, bedTypeOptions, "bedType")}
...
export default RentShortTermScreen
