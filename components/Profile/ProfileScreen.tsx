          ...
          {isVerified && (
            <>
              ...
              {/* <MenuItem 
                icon="list" 
                text="My Listings" 
                onPress={() => router.push("/dashboard/mylistings")} 
              /> */}
            </>
          )}
...
// import { ownerAPI, type User } from "@/services/userApi" // Adjust path as needed, import User type
// import { Ionicons } from "@expo/vector-icons"
// import AsyncStorage from "@react-native-async-storage/async-storage"
// import { Link, useNavigation, useRouter } from "expo-router"
// import type React from "react"
...
//         const userData = await ownerAPI.getCurrentUser() // Changed this line to use getCurrentUser
//         if (userData) {
//           setUser(userData)
//         } else {
//           Alert.alert("Error", "Failed to fetch user data. Please try logging in again.")
//           router.replace("/authentication/signin") // Redirect to login
//         }
//       } catch (error) {
//         console.error("Error fetching user profile:", error)
//         Alert.alert("Error", "Failed to fetch user data")
...
//     fetchUserData()
//   }, []) // Removed [isVerified] from dependency array to avoid re-fetching on verification status change,
//   // as verification status is derived from user data itself.
//   // The effect should run once on mount or when user context changes.
//   // If user context changes, it should be handled by AuthContext.
...
//             <View>
//               <Text style={styles.name}>{user?.name || "Joe Doe"}</Text>
//               <Text style={styles.phone}>{user?.phone_number || "No User"}</Text>
//             </View>
//           </View>
//           <Link href="/authentication/edit" asChild>
//             <TouchableOpacity>
...
//           />
//           <MenuItem icon="card-outline" text="Payment methods" onPress={() => router.push("/payments")} />
//           <MenuItem icon="help-circle-outline" text="Get help" onPress={() => router.push("/help")} />
//           <MenuItem icon="settings-outline" text="Settings" onPress={() => router.push("/settings")} />
